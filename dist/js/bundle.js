...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _helperFunctions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helperFunctions */ \"./src/js/helperFunctions.js\");\n/* harmony import */ var _models_GameBoard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/GameBoard */ \"./src/js/models/GameBoard.js\");\n/* harmony import */ var _models_Animal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/Animal */ \"./src/js/models/Animal.js\");\n/* harmony import */ var _movements__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./movements */ \"./src/js/movements.js\");\n\n\n\n\n\nvar app = function () {\n  var canvas;\n  var animalImageSheet;\n  var backgroundImage;\n  var board = new _models_GameBoard__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\n  var GAME_STATES = {\n    Normal: 1,\n    Pause: 2,\n    Completed: 3\n  };\n  var gameState = GAME_STATES.Normal;\n\n  var getMousePos = function getMousePos(canvas, evt) {\n    var rect = canvas.getBoundingClientRect();\n    return {\n      x: evt.clientX - rect.left,\n      y: evt.clientY - rect.top\n    };\n  };\n\n  var writeMessage = function writeMessage(canvas, message) {\n    console.log(message);\n  };\n\n  var newGame = function newGame() {\n    var sheep = new _models_Animal__WEBPACK_IMPORTED_MODULE_2__[\"default\"](\"sheet\", 10, 10);\n    board.addGameObject(sheep);\n  };\n\n  var setupEventListeners = function setupEventListeners() {\n    canvas.addEventListener(\"mousemove\", function (evt) {\n      var mousePos = getMousePos(canvas, evt);\n      var message = \"Mouse position: \" + mousePos.x + \",\" + mousePos.y; //  writeMessage(canvas, message);\n    }, false);\n    canvas.addEventListener(\"click\", function (evt) {\n      var mousePos = getMousePos(canvas, evt);\n      var message = \"Click position: \" + mousePos.x + \",\" + mousePos.y;\n      writeMessage(canvas, message);\n      board.checkClick(mousePos.x, mousePos.y);\n    }, false);\n\n    document.getElementById(\"clear\").onclick = function () {\n      newGame();\n    };\n  };\n\n  var start = function start() {\n    var backgroundLoaded = backgroundImage.complete && backgroundImage.naturalHeight !== 0;\n    var animalImageSheetLoaded = animalImageSheet.complete && animalImageSheet.naturalHeight !== 0;\n    if (backgroundLoaded && animalImageSheetLoaded) console.log(\"game starting\");\n  };\n\n  var update = function update() {\n    board.update();\n  };\n\n  return {\n    init: function init() {\n      canvas = document.querySelector(\"#game\"); // Canvas size depends on the windows grid\n\n      canvas.height = canvas.getBoundingClientRect().height;\n      canvas.width = canvas.getBoundingClientRect().width;\n      setupEventListeners();\n      backgroundImage = new Image();\n      backgroundImage.onload = start;\n      backgroundImage.src = \"https://i.imgur.com/brRdck7.png\";\n      animalImageSheet = new Image();\n      animalImageSheet.onload = start;\n      animalImageSheet.src = \"https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/3a29bffb-b0ad-46ad-b5a1-15ef7501b677/datsnt7-949b4894-6a57-4b59-b79d-cdcc015ff582.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1cm46YXBwOiIsImlzcyI6InVybjphcHA6Iiwib2JqIjpbW3sicGF0aCI6IlwvZlwvM2EyOWJmZmItYjBhZC00NmFkLWI1YTEtMTVlZjc1MDFiNjc3XC9kYXRzbnQ3LTk0OWI0ODk0LTZhNTctNGI1OS1iNzlkLWNkY2MwMTVmZjU4Mi5wbmcifV1dLCJhdWQiOlsidXJuOnNlcnZpY2U6ZmlsZS5kb3dubG9hZCJdfQ.tT1Ez6uLOVAcxqdEj0W6VvAEVoLL0IwnHViPV73a4To\";\n      board.init(canvas);\n      board.setBackground(backgroundImage);\n      var animal = new _models_Animal__WEBPACK_IMPORTED_MODULE_2__[\"default\"](\"animal1\");\n      animal.init(animalImageSheet, 91, 320, 30, 30, 0, 10);\n      animal.setMovement(_movements__WEBPACK_IMPORTED_MODULE_3__[\"walk\"]);\n      board.addGameObject(animal);\n      var animal2 = new _models_Animal__WEBPACK_IMPORTED_MODULE_2__[\"default\"](\"animal2\");\n      animal2.init(animalImageSheet, 91, 320, 30, 30, 0, 150);\n      board.addGameObject(animal2);\n      setInterval(update, 150); // 33 milliseconds = ~ 30 frames per sec\n    }\n  };\n}();\n\napp.init();\n\n//# sourceURL=webpack:///./src/js/app.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return GameBaseObject; });\n/* harmony import */ var _Position__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Position */ \"./src/js/models/Position.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar GameBaseObject = /*#__PURE__*/function () {\n  function GameBaseObject(name) {\n    _classCallCheck(this, GameBaseObject);\n\n    this.name = name;\n    this.position = null;\n    this.image = null;\n    this.imgPosition = null;\n    this.movementFunction = null;\n    this.frame = 0;\n  }\n\n  _createClass(GameBaseObject, [{\n    key: \"init\",\n    value: function init(image, imgPosX, imgPosY, imgWidth, imgHeight, posX, posY) {\n      this.image = image;\n      this.imgPosition = new _Position__WEBPACK_IMPORTED_MODULE_0__[\"default\"](imgPosX, imgPosY, imgWidth, imgHeight);\n      this.position = new _Position__WEBPACK_IMPORTED_MODULE_0__[\"default\"](posX, posY, imgWidth, imgHeight);\n    }\n  }, {\n    key: \"setMovement\",\n    value: function setMovement(movementFunction) {\n      this.movementFunction = movementFunction;\n    }\n  }, {\n    key: \"checkClick\",\n    value: function checkClick(x, y) {\n      if (this.position.isHit(x, y)) console.log(\"hit!\");\n    }\n  }, {\n    key: \"getName\",\n    value: function getName() {\n      return this.name;\n    }\n  }, {\n    key: \"update\",\n    value: function update(ctx) {\n      if (this.movementFunction) {\n        this.position = this.movementFunction(this.position);\n      }\n\n      var imageSheet = [0, 1, 2, 1];\n      ctx.drawImage(this.image, this.imgPosition.x + imageSheet[this.frame % 4] * 33, this.imgPosition.y, this.imgPosition.w, this.imgPosition.h, this.position.x, this.position.y, this.position.w, this.position.h);\n      this.frame++;\n    }\n  }]);\n\n  return GameBaseObject;\n}();\n\n\n\n//# sourceURL=webpack:///./src/js/models/GameBaseObject.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"walk\", function() { return walk; });\nvar walk = function walk(position) {\n  position.x += 10;\n  position.d = 90;\n  return position;\n};\n\n//# sourceURL=webpack:///./src/js/movements.js?");
